                ...
                <table className="results-by-table">
                    ...
                    <tbody className="results__content">
                        <tr className="columns-4">
                            ...
                            <td className="">£ {recordObject.initialAnnualSalary.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            ...
                            <td className="">£ {recordObject?.taxPaidYearly.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            <td className="">£ {recordObject?.niPaidYearly.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            <td className="">£ {(recordObject?.initialAnnualSalary - (Number(recordObject.pensionDeductionAnnualy) + Number(recordObject.sfPaidAnnualy) + Number(recordObject?.taxPaidYearly) + Number(recordObject?.niPaidYearly))).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                        </tr>
                        <tr className="columns-4">
                            <td className="">Monthly</td>
                            <td className="">£ {recordObject.initialMonthlySalary.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            ...
                            <td className="">£ {recordObject?.taxPaidMonthly.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            <td className="">£ {recordObject?.niPaidMonthly.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            <td className="">£ {((recordObject?.initialAnnualSalary / 12) - (Number(recordObject.pensionDeductionMonthly) + Number(recordObject.sfPaidMonthly) + Number(recordObject?.taxPaidMonthly) + Number(recordObject?.niPaidMonthly))).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                        </tr>
                        <tr className="columns-4">
                            <td className="">Weekly</td>
                            <td className="">£ {recordObject.initialWeeklySalary.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            ...
                            <td className="">£ {recordObject?.taxPaidWeekly.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            <td className="">£ {recordObject?.niPaidWeekly.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            <td className="">£ {((recordObject?.initialAnnualSalary / 52) - (Number(recordObject.pensionDeductionWeekly) + Number(recordObject.sfPaidWeekly) + Number(recordObject?.taxPaidWeekly) + Number(recordObject?.niPaidWeekly))).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",").toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                        </tr>
                        <tr className="columns-4">
                            <td className=""><abbr title="">Daily</abbr></td>
                            <td className="">£ {recordObject.initialDailySalary.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            ...
                            <td className="">£ {recordObject?.taxPaidDaily.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            <td className="">£ {recordObject?.niPaidDaily.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                            <td className="">£ {((recordObject?.initialAnnualSalary / 260) - (Number(recordObject.pensionDeductionDaily) + Number(recordObject.sfPaidDaily) + Number(recordObject?.taxPaidDaily) + Number(recordObject?.niPaidDaily))).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",").toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                        </tr>
                    </tbody>
                </table>
